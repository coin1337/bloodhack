...
public class BloodHackTessellator extends Tessellator {
   public static BloodHackTessellator INSTANCE = new BloodHackTessellator();

   public BloodHackTessellator() {
      super(2097152);
   }
   ...
   public static void draw_cube_line(float x, float y, float z, int argb, String sides) {
      ...
      int g = argb >>> 8 & 255;
      int b = argb & 255;
      draw_cube_line(INSTANCE.func_178180_c(), x, y, z, 1.0F, 0.5645F, 1.0F, r, g, b, a, sides);
   }
