...
public class CrystalUtil {
   ...
   public static boolean canPlaceCrystal(BlockPos pos) {
      ...
      if (block == Blocks.field_150343_Z || block == Blocks.field_150357_h) {
         ...
         if (floor == Blocks.field_150350_a && ceil == Blocks.field_150350_a) {
            return mc.field_71441_e.func_72839_b((Entity)null, new AxisAlignedBB(pos.func_177982_a(0, 1, 0))).isEmpty() && mc.field_71441_e.func_72839_b((Entity)null, new AxisAlignedBB(pos.func_177982_a(0, 2, 0))).isEmpty();
         }
      }
   ...
   public static float getDamageMultiplied(float damage) {
      int diff = mc.field_71441_e.func_175659_aa().hashCode();
